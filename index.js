!(function () {
  ...
  class hn {
    constructor(t) {
      (this.DOM = { el: t }),
        (this.DOM.backCtrl = this.DOM.el.querySelector(".preview_item-back")),
        (this.DOM.imgWrap = this.DOM.el.querySelector(
          ".preview_item-imgwrap"
        )),
        (this.DOM.image = this.DOM.imgWrap.querySelector(".preview_item-img")),
        (this.DOM.title = this.DOM.el.querySelector(".preview_item-title")),
  ...
  class fn {
    constructor(t) {
      (this.DOM = { el: t }),
        (this.DOM.image = this.DOM.el.querySelector(".grid_item-img")),
  ...
  t(mn)();
  const _n = [
    ...document.querySelector(".content_title").querySelectorAll(".char"),
  ];
  class gn extends Yi.EventEmitter {
    constructor(t) {
      super(),
        (this.DOM = { el: t }),
        (this.gridItems = []),
        (this.DOM.items = [...this.DOM.el.querySelectorAll(".grid_item")]),
    ...
    showContent(t) {
      ...
      Ii.timeline()
        ...
        .add(() => {
          t.preview.DOM.el.classList.add("preview_item-open");
        }, "start+=0.1")
        .to(
    ...
    hideContent(t) {
      ...
      (this.isContentOpen = !1),
        Ii.timeline({
          onComplete: () => {
            t.preview.DOM.el.classList.remove("preview_item-open"),
  ...
  const vn = new (class {
    constructor(t) {
      (this.DOM = { el: t }),
        (this.DOM.svg = this.DOM.el.querySelector(".cursor_svg")),
        (this.DOM.circle = this.DOM.svg.querySelector(".cursor_svg-circle")),
        (this.DOM.circle.style.transformOrigin = "50% 50%"),
        (this.DOM.text = this.DOM.el.querySelector(".cursor_text")),
  ...
  new Promise((t, e) => {
    ...
    [...document.querySelectorAll("a, button, .grid_item")].forEach((t) => {
